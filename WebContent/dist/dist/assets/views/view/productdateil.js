...
!function (t) {
  function e(n) {
    ...
    var n,
        r,
        o = [];o.push(i(124)), n = i(123);var s = i(125);r = n = n || {}, "object" != (0, _typeof3.default)(n.default) && "function" != typeof n.default || ((0, _keys2.default)(n).some(function (t) {
      return "default" !== t && "__esModule" !== t;
    }) && console.error("named exports are not supported in *.vue files."), r = n = n.default), "function" == typeof r && (r = r.options), r.__file = "D:\\weexWorkspace\\android\\ConsumeloanWX\\node_modules\\weex-ui\\packages\\wxc-minibar\\index.vue", r.render = s.render, r.staticRenderFns = s.staticRenderFns, r._scopeId = "data-v-71dc140a", r.style = r.style || {}, o.forEach(function (t) {
      for (var e in t) {
        r.style[e] = t[e];
      }
    }), "function" == typeof __register_static_styles__ && __register_static_styles__(r._scopeId, o), t.exports = n;
  }, 123: function _(t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });var n = weex.requireModule("navigator");e.default = { props: { backgroundColor: { type: String, default: "#FFC900" }, leftButton: { type: String, default: "https://gw.alicdn.com/tfs/TB1x18VpwMPMeJjy1XdXXasrXXa-21-36.png" }, textColor: { type: String, default: "#3D3D3D" }, rightButton: { type: String, default: "" }, title: { type: String, default: "标题" }, leftText: { type: String, default: "" }, rightText: { type: String, default: "" }, useDefaultReturn: { type: Boolean, default: !0 }, show: { type: Boolean, default: !0 } }, methods: { leftButtonClicked: function leftButtonClicked() {
          var t = this;t.useDefaultReturn && n.pop({}, function (t) {}), t.$emit("wxcMinibarLeftButtonClicked", {});
  ...
  }, 231: function _(t, e, i) {
    var n,
        r,
        o = [];o.push(i(187)), n = i(184);var s = i(190);r = n = n || {}, "object" != (0, _typeof3.default)(n.default) && "function" != typeof n.default || ((0, _keys2.default)(n).some(function (t) {
      return "default" !== t && "__esModule" !== t;
    }) && console.error("named exports are not supported in *.vue files."), r = n = n.default), "function" == typeof r && (r = r.options), r.__file = "D:\\weexWorkspace\\android\\ConsumeloanWX\\src\\assets\\views\\view\\productdateil.vue", r.render = s.render, r.staticRenderFns = s.staticRenderFns, r._scopeId = "data-v-b7d44808", r.style = r.style || {}, o.forEach(function (t) {
      for (var e in t) {
        r.style[e] = t[e];
      }
    }), "function" == typeof __register_static_styles__ && __register_static_styles__(r._scopeId, o), t.exports = n, t.exports.el = "true", new Vue(t.exports);
  }, 56: function _(t, e, i) {
    "use strict";
    function n(t) {
      return t && t.__esModule ? t : { default: t };
    }Object.defineProperty(e, "__esModule", { value: !0 });var r = i(122);Object.defineProperty(e, "default", { enumerable: !0, get: function get() {
        return n(r).default;
      } });
  } });
//# sourceMappingURL=productdateil.js.map